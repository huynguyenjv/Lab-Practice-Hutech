...
import fit.hutech.huynguyen.repositories.CategoryRepository;
...
public class CategoryService {
 ...
 /* Delete a category by its id.
    ...
    */
    public boolean checkCategoryHasProduct(String id){
        return categoryRepository.findById(id).get().getProducts().isEmpty();
    }
